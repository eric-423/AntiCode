...
const NewTaskExist = ({ setShowModal, itemExist, setRefreshData }) => {
  ...
  const setDataItem = (itemExist) => {
    setTaskName(itemExist.taskName)
    setStartDate(itemExist.startDate)
    setDueDate(itemExist.dueDate)
    setCreatedAt(itemExist.createdAt)
    setCompletedAt(itemExist.completedAt)
    setTaskDescription(itemExist.taskDescription)
